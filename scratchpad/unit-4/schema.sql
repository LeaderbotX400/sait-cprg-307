-- NOTE:  First time executing will result in 45 errors because DROP/ALTER being performed on objects
-- that do not exist.  If execute a second time, no errors will occur.
